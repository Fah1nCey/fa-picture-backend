...
import com.fafa.fapicturebackend.model.enums.PictureReviewStatusEnum;
import com.fafa.fapicturebackend.model.vo.PictureTagCategory;
import com.fafa.fapicturebackend.model.vo.PictureVO;
import com.fafa.fapicturebackend.service.PictureService;
import com.fafa.fapicturebackend.service.SpaceService;
...
public class PictureController {
    ...
    public BaseResponse<PictureVO> getPictureVOById(long id, HttpServletRequest request) {
        ...
        if (!PictureReviewStatusEnum.PASS.equals(statusEnum)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR, "图片未审核通过");
        }
        // 获取封装类
     ...
     * 分页获取图片列表（缓存）
     */
    @Deprecated // 私有空间的图片更新频率不好把控，暂时废弃
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        String redisKey = "fapicture:listPictureVOByPage:" + hashKey;
        // 查询缓存
